...
<div class="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
    <h1 class="text-2xl font-bold mb-6 text-center">ثبت پرداخت ماهانه</h1>
    @if($errors->any())
    ...
    @endif
    <form id="payment-form" action="{{ route('admin.monthlypayment') }}" method="POST" onsubmit="disableSubmitButton()">
        @csrf

        <div class="mb-4">
            <label for="number" class="block text-gray-700 font-semibold mb-2">مقدار پرداخت ماهانه:</label>
