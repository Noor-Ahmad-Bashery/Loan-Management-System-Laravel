...
<div class="container mx-auto py-10">
    ...
    <form action="{{ route('admin.updateAdditionalPayment', ['id' => $payment->id]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="date" name="payment_date" id="payment_date" value="{{ $payment->created_at->format('Y-m-d') }}" class="border rounded py-2 px-4 w-full">
        </div>
